  ...
  -- fuzzy finder
  {
    ...
    keys = {
      ...
      { "<leader>a", "<cmd>Telescope live_grep<cr>", desc = "Live Grep search in current directory" },
      {
        ...
        desc = "Grep search for the string under your cursor or selection in current directory",
      },
      -- 'search' leaders
      {
        "<leader>sa",
  ...
  -- Search/replace in multiple files
  {
    ...
    keys = {
      { "<leader>r", '<cmd>lua require("spectre").open()<CR>', desc = "Open search and replace (Spectre)" },
      {
        ...
        desc = "Search and replace current word under cursor (Spectre)",
      },
      {
        "<leader>rw",
        '<esc><cmd>lua require("spectre").open_visual()<CR>',
        mode = "x",
        desc = "Search and replace currently selection (Spectre)",
      },
      {
        "<leader>rc",
        '<cmd>lua require("spectre").open_file_search({select_word=true})<CR>',
        desc = "Search and replace on current file (Spectre)",
      },
    },
  },
}
